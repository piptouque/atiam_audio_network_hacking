...
\subsubsection{Uninformed models} 

\subsubsection{Informed models} 


\subsection{Contrôle et expressivité}

\subsubsection{Interpretable latent space for top level control} 


\subsubsection{Controlling Informed models}  --NILS, CHRISTOPHE


\subsection{Réduction des modèles - Temps réel} 
...
Application : 
- Morphisme entre instruments 
- Transfert de timbre : in-out
- Target evolution of audio descriptors  / - Semantic control
- Synthese de sons complexes : percus, autres
- Polyphonie / Generation d'accords 
- 
