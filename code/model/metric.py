...
def vae_reconstruction_loss(_output: torch.Tensor, target: torch.Tensor, model: ImageVae) -> Variable:
...
def vae_divergence_loss(_output: torch.Tensor, target: torch.Tensor, model: ImageVae) -> Variable:
